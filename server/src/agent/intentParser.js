...
function isGenericRidePlaceholder(rideName) {
...
function isGenericAddToCartMessage(message) {
...
function extractRideName(message) {
...
function parseMessage(message) {
  ...
  if (/(הזמן כרטיס|הזמנת כרטיס|book ticket|להזמין)/.test(text)) {
    ...
    if (params.ticketType === 'hourly' && !params.hoursAmount && (params.startHour == null || params.endHour == null)) {
