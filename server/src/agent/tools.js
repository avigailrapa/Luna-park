const TOOL_CATALOG = [
  ...
  },
  {
    ...
    path: '/api/rides/:id',
    roles: ['guest', 'customer', 'admin'],
    description: 'פרטי מתקן לפי מזהה',
  ...
  },
  {
    ...
    path: '/api/rides',
    roles: ['admin'],
    description: 'יצירת מתקן (ללא העלאת קובץ)',
    params: [
      { name: 'name', required: true },
...
module.exports = { TOOL_CATALOG, getToolsForRole, getToolById, getUserRole };
